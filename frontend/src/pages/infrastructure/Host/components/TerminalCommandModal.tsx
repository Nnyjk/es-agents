...
export const TerminalCommandModal: React.FC<TerminalCommandModalProps> = ({
  visible,
  onClose,
  onExecute,
  hostOs,
  ...
  const [editingItem, setEditingItem] = useState<Partial<AgentCommand> | null>(
    null,
  );
      ...
      >
        <ProTable<AgentCommand>
          ...
          request={async () => {
            ...
            const osType =
              hostOs.toUpperCase() as import("../../../../types").OsType;
