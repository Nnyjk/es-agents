  ...
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        title: "3. 创建配置文件",
        description:
          "在 host-agent 目录中创建 config.yaml 文件，填入主机身份信息。",
        command: windows
      ...
      },
      {
        ...
        title: "4. 后台启动 Agent",
        description:
          "安装命令会以后台方式启动 Agent，并立即返回控制台。可通过日志与 PID 文件确认进程状态。",
      ...
      },
      {
        ...
        title: "5. 发起连接验证",
        description:
          'Agent 后台启动后，回到当前弹窗点击"连接 Host Agent"由服务端主动验证连接。',
      },
    ],
  };
};
