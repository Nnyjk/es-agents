        ...
        <Row gutter={16}>
          <Col span={6}>
            <Input
              ...
              onChange={(e) =>
                setSearchParams({ ...searchParams, serviceId: e.target.value })
              }
          ...
          <Col span={6}>
            <Input
              ...
              onChange={(e) =>
                setSearchParams({ ...searchParams, operation: e.target.value })
              }
              onPressEnter={loadTraces}
            />
          </Col>
          <Col span={6}>
            <RangePicker
              ...
              onChange={(dates) =>
                setSearchParams({ ...searchParams, timeRange: dates as any })
              }
            />
          </Col>
          <Col span={6}>
