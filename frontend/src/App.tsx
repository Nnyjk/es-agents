...
const AgentMonitorPage = lazy(
  () => import("./pages/agentMonitoring/AgentMonitorPage"),
);
const AgentInstancePage = lazy(
  () => import("./pages/agentMonitoring/AgentInstancePage"),
);

// Infrastructure
const EnvironmentList = lazy(
  () => import("./pages/infrastructure/Environment"),
);
const HostList = lazy(() => import("./pages/infrastructure/Host"));

// Goal Hub & Deployments
const GoalHub = lazy(() =>
  import("./pages/goal-hub").then((m) => ({ default: m.GoalHub })),
);
const DeploymentWizard = lazy(() => import("./pages/goals/DeploymentWizard"));
const DeploymentPage = lazy(() => import("./pages/deployment"));
const DeploymentListPage = lazy(() =>
  import("./pages/deployments").then((m) => ({
    default: m.DeploymentListPage,
  })),
);
...
const DeploymentCreatePage = lazy(() =>
  import("./pages/deployments").then((m) => ({
    default: m.DeploymentCreatePage,
  })),
);
...
const NotificationChannelsList = lazy(
  () => import("./pages/settings/NotificationChannels"),
);
const NotificationTemplatesList = lazy(
  () => import("./pages/settings/NotificationTemplates"),
);
const NotificationHistoryList = lazy(
  () => import("./pages/settings/NotificationHistory"),
);
...
const PluginMarketPage = lazy(() =>
  import("./pages/pluginMarketplace").then((m) => ({
    default: m.PluginMarketPage,
  })),
);
...
const CommandTemplatePage = lazy(
  () => import("./pages/command/CommandTemplatePage"),
);
...
const BatchOperationsPage = lazy(() =>
  import("./pages/batch").then((m) => ({ default: m.BatchOperationsPage })),
);
const BatchOperationDetailPage = lazy(() =>
  import("./pages/batch").then((m) => ({
    default: m.BatchOperationDetailPage,
  })),
);
...
const TracingPage = lazy(() => import("./pages/tracing/TracingPage"));
...
// Template Wizard
const TemplateWizard = lazy(() =>
  import("./pages/templates").then((m) => ({ default: m.TemplateWizard })),
);
